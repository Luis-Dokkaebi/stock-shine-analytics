...
const costBreakdown = [
  { name: "Renta", value: 12500, color: "hsl(174, 72%, 56%)" },
  { name: "Personal", value: 8200, color: "hsl(199, 89%, 48%)" },
  { name: "Servicios", value: 3500, color: "hsl(38, 92%, 50%)" },
  { name: "Baja Rotación", value: 6890, color: "hsl(0, 72%, 51%)" },
  { name: "Otros", value: 2500, color: "hsl(220, 10%, 55%)" },
];
  ...
  return (
    <MainLayout>
      <PageHeader 
        ...
        subtitle="Análisis de gastos de almacén y penalización por rotación"
      >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <MetricCard
          ...
          value="$45.20"
          icon={Warehouse}
          description="2,500 m² de almacén"
          delay={0.2}
        />
        <MetricCard
          title="Días Promedio"
        ...
        >
          <div className="space-y-4">
            <div className="p-4 rounded-lg bg-success/10 border border-success/20">
              ...
              <p className="text-xs text-muted-foreground">156 productos</p>
            </div>
            <div className="p-4 rounded-lg bg-warning/10 border border-warning/20">
              ...
              <p className="text-xs text-muted-foreground">89 productos - $2,340 en penalización</p>
            </div>
            <div className="p-4 rounded-lg bg-destructive/10 border border-destructive/20">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-medium">Baja Rotación (61-90 días)</span>
                <span className="text-destructive font-semibold">1.5% del valor</span>
              </div>
              <p className="text-xs text-muted-foreground">34 productos - $3,120 en penalización</p>
            </div>
            <div className="p-4 rounded-lg bg-destructive/20 border border-destructive/30">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-medium">Sin Movimiento (+90 días)</span>
                <span className="text-destructive font-semibold">3% del valor</span>
              </div>
              <p className="text-xs text-muted-foreground">12 productos - $1,430 en penalización</p>
            </div>
          </div>
        </DashboardCard>
      </div>
      ...
      <DashboardCard 
        ...
        subtitle="Configuración de costos fijos y variables"
        delay={1.0}
        action={
